...
def hashing():
		call("clear", shell = True);print "\nhashing by Mr.w0n63d4n\ntesting script\n";print "\nsilahkan pilih jenis hash\n\n[1].md5\n[2].SHA1\n[3].SHA224\n[4].SHA256\n[5].SHA384\n[6].SHA512\n";susu = raw_input("pilih salah satu: ")
		if susu == '1' or susu == 'satu':
			try:
				ceck = raw_input("masukan yang mau dihash: ");hasin = md5();hasil = hasin.update(ceck);hajar = hasin.hexdigest();joni = "hasil hashing "+k+"=> "+u+hajar+g;sleep(0.5);print joni;sleep(0.5);print ""
			except KeyboardInterrupt:
				pilih()
		if susu == '2' or susu == 'dua':
			try:
				ceck = raw_input("masukan yang mau dihash: ");hasin = sha1();hasil = hasin.update(ceck);hajar = hasin.hexdigest();joni = "hasil hashing "+k+"=> "+u+hajar+g;sleep(0.5);print joni;sleep(0.5);print ""
			except KeyboardInterrupt:
				pilih()
		if susu == '3' or susu == 'tiga':
			try:
				ceck = raw_input("masukan yang mau dihash: ");hasin = sha224();hasil = hasin.update(ceck);hajar = hasin.hexdigest();joni = "hasil hashing "+k+"=> "+u+hajar+g;sleep(0.5);print joni;sleep(0.5);print ""
			except KeyboardInterrupt:
				pilih()
		if susu == '4' or susu == 'empat':
			try:
				ceck = raw_input("masukan yang mau dihash: ");hasin = sha256();hasil = hasin.update(ceck);hajar = hasin.hexdigest();joni = "hasil hashing "+k+"=> "+u+hajar+g;sleep(0.5);print joni;sleep(0.5);print ""
			except KeyboardInterrupt:
				pilih()
		if susu == '5' or susu == 'lima':
			try:
				ceck = raw_input("masukan yang mau dihash: ");hasin = sha384();hasil = hasin.update(ceck);hajar = hasin.hexdigest();joni = "hasil hashing "+k+"=> "+u+hajar+g;sleep(0.5);print joni;sleep(0.5);print ""
			except KeyboardInterrupt:
				pilih()
		if susu == '6' or susu == 'enam':
			try:
				ceck = raw_input("masukan yang mau dihash: ");hasin = sha512();hasil = hasin.update(ceck);hajar = hasin.hexdigest();joni = "hasil hashing "+k+"=> "+u+hajar+g;sleep(0.5);print joni;sleep(0.5);print ""
			except KeyboardInterrupt:
				pilih()
		else:
