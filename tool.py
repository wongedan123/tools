...
def main():
    ...
    if choice == '17' or choice == 'tujuh belas':
			...
			if wibu == "1" or wibu == "01":
				one(),pilih()
			if wibu == "2" or wibu == "02":
				two(),pilih()
			if wibu == "3" or wibu == "03":
				tiga(),pilih()
			if wibu == "4" or wibu == "04":
				four(),pilih()
			if wibu == "5" or wibu == "05":
				five(),pilih()
			if wibu == "6" or wibu == "06":
				six(),pilih()
			if wibu == "7" or wibu == "07":
				seven(),pilih()
			if wibu == "8" or wibu == "08":
				lapan(),pilih()
			if wibu == "9" or wibu == "09":
				nine(),pilih()
			if wibu == "10":
				ten(),pilih()
			if wibu == "11":
